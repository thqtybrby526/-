...
export default function Admin() {
  ...
  const [pendingDeleteAction, setPendingDeleteAction] = useState<{
    listKey: "lead_new" | "lead_completed" | "lead_no_reply" | "callback" | "complaint" | "parent" | "ticket";
    id: string;
    studentName: string;
    onConfirmed: () => void;
  } | null>(null);
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-6 text-right font-sans" dir="rtl">
        ...
        {showGoogleModal && (
          <div className="fixed inset-0 bg-slate-950/85 backdrop-blur-xs flex items-center justify-center p-4 z-50 text-right font-sans" dir="rtl">
  ...
  return (
    <div className="min-h-screen bg-slate-100 p-4 md:p-8 font-sans transition-all text-right" dir="rtl">
      ...
      <div className="max-w-7xl mx-auto flex flex-col xl:flex-row items-center justify-between gap-4 mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 w-full xl:w-auto">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h1 className="text-xl md:text-2xl font-black text-slate-900 tracking-tight">البيئة الإدارية المستقلة الشاملة</h1>
              <p className="text-xs text-slate-500 font-extrabold flex items-center gap-1.5 mt-0.5">
                <span>قاعدة بيانات الطلاب والمسجلين الحية 🟢</span>
                <span className="text-[10px] bg-indigo-150 text-indigo-700 px-2 py-0.2 rounded">تحديث حي تلقائي</span>
              </p>
            </div>
          </div>
      ...
      <div ref={adminCounterRef} className="mb-6 w-full hidden md:block">
        ...
        <div className="bg-white p-5 md:p-6 rounded-3xl border border-slate-200 shadow-3xs space-y-6">
          
          {/* 1. Permanent, prominent search and quick filters block */}
          <div className="bg-slate-50 p-4 rounded-2xl border border-slate-205 flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-2 border-b border-slate-200 pb-3">
              ...
              <span className="text-[11px] text-slate-400 font-bold">يرجى استخدام الحقول بالأسفل للوصول السريع للمحافظات والطلاب</span>
            </div>

            {/* Grid/Flex of inputs - stacked nicely on mobile and grid on desktop */}
            <div className="flex flex-col md:grid md:grid-cols-12 gap-3.5 w-full">
              ...
              <div className="md:col-span-4 relative">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white border border-slate-205 font-bold text-xs text-slate-800 rounded-lg p-2.5 pr-8 focus:ring-1 focus:ring-amber-500 focus:outline-none text-right shadow-3xs"
                  />
              ...
              <div className="md:col-span-2">
                ...
                <select
                  ...
                  className="w-full bg-white border border-slate-200 font-bold text-xs text-slate-800 rounded-lg p-2.5 focus:ring-1 focus:ring-amber-500 cursor-pointer text-right shadow-3xs"
                >
                ...
                {adminComplaints.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {adminComplaints.map((item) => (
                      <div key={item.id} className="block bg-white p-4 rounded-xl mb-3 border sm:mb-0 sm:p-5 sm:rounded-2xl border-slate-200 hover:border-rose-400 transition-all relative space-y-3 shadow-xs text-right">
                        <div className="flex justify-between items-center border-b border-slate-100 pb-2.5">
                          ...
                          <span className="text-[10px] text-slate-450 font-mono">{item.date}</span>
                        </div>
                ...
                {filteredCallbacksList.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {filteredCallbacksList.map((cb) => (
                      <div key={cb.id} className={`block bg-white p-4 rounded-xl mb-3 border sm:mb-0 sm:p-5 sm:rounded-2xl transition-all space-y-3 shadow-xs text-right overflow-hidden ${
                        ...
                        <div className="flex justify-between items-center border-b border-slate-100 pb-2">
                          <div className="flex items-center gap-1.5 flex-wrap">
                            ...
                            {cb.status === "completed" && cb.agentName && (
                              <span className="text-[10px] bg-indigo-50 text-indigo-800 border border-indigo-150 px-2 py-0.5 rounded font-black max-w-[130px] truncate" title={cb.agentName}>
                                المسؤول: {cb.agentName}
                              </span>
                            )}
                          </div>
                          <span className="text-[10px] text-slate-400 font-mono">{cb.date}</span>
                        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {filteredLeadsList.map((student) => {
                      ...
                      return (
                        <div
                          key={student.id}
                          className={`block bg-white p-4 rounded-xl mb-3 border md:mb-0 md:rounded-2xl transition-all ${
                          ...
                          } ${isExpanded ? "p-5 space-y-4" : "space-y-2"} hover:shadow-xs`}
                        >
                          ...
                          <div className="flex items-center justify-between border-b border-slate-100 pb-2 flex-wrap gap-2">
                            <div className="flex items-center gap-2">
                              ...
                              <span
                                className="font-extrabold text-sm text-slate-900 cursor-pointer flex items-center gap-1 hover:text-amber-700 transition"
                                onClick={() => toggleStudentExpand(student.id)}
                              >
                                <User className="w-4 h-4 text-slate-400 shrink-0" />
                          ...
                          {!isExpanded ? (
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-right">
                              <div className="flex flex-wrap items-center gap-1.5 text-[11px]">
                                ...
                                {student.agentName ? (
                                  <span className="bg-indigo-50 text-indigo-950 border border-indigo-150 px-2 py-0.5 rounded text-[10px] font-bold">
                                    السيلز: {student.agentName}
                                  </span>
                                ) : (
                                  <span className="bg-amber-50 text-amber-805 border border-amber-200 px-2 py-0.5 rounded text-[10px] font-extrabold animate-pulse">
                                    ⚠️ انتظار مندوب
                                  </span>
                                )}
                                ...
                                {student.governorate && (
                                  <span className="text-slate-650 font-bold text-[9.5px]">📍 {student.governorate}</span>
                                )}
                              </div>

                              <div className="flex items-center justify-between sm:justify-end gap-1.5 pt-2 sm:pt-0 shrink-0 border-t sm:border-t-0 border-slate-100">
                                <div className="flex items-center gap-1">
                                  ...
                                  {student.whatsappNumber && (
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noreferrer"
                                      className="w-7 h-7 bg-emerald-55 text-emerald-600 rounded-lg hover:bg-emerald-110 border border-emerald-205 transition flex items-center justify-center shrink-0"
                                      title="واتساب"
                                    >
                                      <MessageCircle className="w-3.5 h-3.5" />
                                    </a>
                                ...
                                <button
                                  onClick={() => toggleStudentExpand(student.id)}
                                  className="text-[10px] text-amber-955 bg-amber-50 border border-amber-200 px-2.5 py-1 rounded-lg font-black transition cursor-pointer"
                                >
                                  المزيد 📂
                                </button>
                              </div>
                            ...
                            <div className="space-y-4 animate-fade-in text-right">
                              ...
                              <div className="p-3 bg-indigo-50/50 border border-indigo-150 rounded-xl space-y-2">
                                  ...
                                  {editingSalesStudentId !== student.id && (
                                    <button
                                      onClick={() => {
                                        ...
                                        const curRep = student.agentName || "";
                                        if (curRep && activeSalesReps.includes(curRep)) {
                                          setTempSalesOption(curRep);
                                          setTempSalesInput("");
                                        } else if (curRep) {
                                          setTempSalesOption("NEW");
                                          setTempSalesInput(curRep);
                                        } else {
                                          setTempSalesOption("");
                                          setTempSalesInput("");
                                        }
                                      }}
                                      className="text-[10px] font-black text-indigo-700 bg-white hover:bg-[#0A2463] hover:text-white border border-indigo-200 px-2.5 py-1 rounded-md transition"
                                    >
                                      تعديل التعيينات ✍️
                                    </button>
                                  )}
                                ...
                                {editingSalesStudentId === student.id ? (
                                  <div className="space-y-2 bg-white p-3 rounded-lg border border-indigo-150">
                                    <select
                                      value={tempSalesOption}
                                      onChange={(e) => {
                                        setTempSalesOption(e.target.value);
                                        if (e.target.value !== "NEW") setTempSalesInput("");
                                      }}
                                      className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-xs font-extrabold text-slate-800 cursor-pointer"
                                    >
                                      <option value="">-- بدون مستشار (تجاهل أو إرجاع للانتظار المعلق) --</option>
                                      {activeSalesReps.map((rep) => (
                                        <option key={rep} value={rep}>👤 {rep}</option>
                                      ))}
                                      <option value="NEW">➕ تسجيل مستشار مبيعات جديد للمنصة...</option>
                                    </select>
                                    ...
                                    {tempSalesOption === "NEW" && (
                                      <input
                                        ...
                                        placeholder="اكتب اسم الموظف هنا..."
                                        className="w-full p-2 bg-slate-50 border border-slate-205 rounded-lg text-xs font-bold text-slate-850 text-right"
                                      />
                                    )}

                                    <div className="flex items-center gap-2 py-1 justify-end flex-row-reverse">
                                      <input
                                        type="checkbox"
                                        id={`check-transfer-${student.id}`}
                                        checked={transferCheckedList[student.id] || false}
                                        onChange={(e) => {
                                          setTransferCheckedList(prev => ({ ...prev, [student.id]: e.target.checked }));
                                        }}
                                        className="rounded border-slate-350 text-emerald-605 focus:ring-emerald-500 w-4 h-4 cursor-pointer"
                                      />
                                      <label htmlFor={`check-transfer-${student.id}`} className="text-xs font-extrabold text-slate-705 cursor-pointer select-none">
                                        تفعيل خيار (ترحيل للمواصلين بنجاح ✓)
                                      </label>
                                    </div>
                                    ...
                                    <div className="flex gap-2 justify-end pt-1">
                                      <button
                                        onClick={() => {
                                          const finalName = tempSalesOption === "NEW" ? tempSalesInput : tempSalesOption;
                                          if (!finalName || finalName.trim() === "") {
                                            alert("برجاء إدخال اسم مستشار السيلز الموكّل إليه المكالمة!");
                                            return;
                                          }
                                          if (!transferCheckedList[student.id]) {
                                            alert("لتأكيد الحفظ، يجب تفعيل خيار (ترحيل للمواصلين بنجاح ✓) لترحيله لكشف الترتيب العام!");
                                            return;
                                          }
                                          handleSaveSalesAssignment(student.id, finalName);
                                        }}
                                        className="px-3.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-[11px] font-black rounded-lg transition"
                                      >
                                        ترحيل الطالب وحفظ السيلز 💾
                                      </button>
                                      <button
                                        onClick={() => setEditingSalesStudentId(null)}
                                        className="px-2.5 py-1.5 bg-slate-100 text-slate-600 text-[10px] rounded-lg"
                                      >
                                        إلغاء
                                      </button>
                                    </div>
                                  ...
                                  <div className="flex items-center gap-2">
                                    {student.agentName ? (
                                      ...
                                      <span className="text-xs font-bold text-amber-800 bg-amber-50 border border-amber-200 px-3 py-1.5 rounded-lg inline-block animate-pulse">
                                        لم يتم ترحيله للتواصل بعد (قيد السيلز معلق) ⏳
                                      </span>
                                    )}
                                  </div>
                                )}
                          ...
                          <div className="flex flex-col sm:flex-row gap-2.5 justify-between items-stretch sm:items-center pt-2.5 border-t border-slate-100">
                            <div className="flex flex-col sm:flex-row flex-wrap gap-2 w-full sm:w-auto">
                              {student.status !== "completed" && (
                                <button
                                  onClick={() => handleUpdateStatus("lead", student.id, "no_reply")}
                              ...
                              {student.status === "completed" ? (
                                ...
                                <button
                                  ...
                                  className="text-[11px] font-extrabold p-3 sm:px-4 sm:py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white transition cursor-pointer flex items-center justify-center gap-1.5 w-full sm:w-auto text-center"
                                >
                                ...
                                const listKey = 
                                  student.status === "completed" 
                                    ...
                                    : student.status === "no_reply" 
                                      ? "lead_no_reply" 
                                      : "lead_new";
                                triggerSecureDelete(listKey, student.id, student.full_name || "طالب", () => {
      ...
      {pendingDeleteAction && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-xs flex items-center justify-center p-4 z-[9999] text-right font-sans" dir="rtl">
