      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 text-right space-y-3">
          ...
          <p className="text-xs text-slate-650 leading-relaxed font-sans max-w-3xl">
            إذا قمت بالتسجيل وواجهت أي مغالطات أو سلوكيات غير مهنية من مندوبي القبول بالجامعات، أو واجهت مشكلة تقنية بالبوابة، يرجى كتابة التفاصيل مباشرة وسيتولى فريق المراقبة مراجعة السجل وحظر الكيان المخالف فوراً.
          </p>
        </div>
