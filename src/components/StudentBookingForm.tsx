...
export function StudentBookingForm({ preselectedDepts }: StudentBookingFormProps) {
  ...
  const [basicCourse, setBasicCourse] = useState("دورة أكتوبر 2026 (الرئيسية)");
  const [wantsEquivalence, setWantsEquivalence] = useState(false);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Egyptian mobile validation check recommendation
    const cleanPhone = phoneNumber.replace(/[\s\-\(\)]/g, "");
    if (cleanPhone.length < 8) {
      setError("الرجاء إدخال رقم هاتف صحيح لكي نتمكن من الاتصال بك.");
      return;
    }
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-navy/20 focus:border-brand-navy transition text-right"
              />
              {(() => {
                ...
                return (
                  <div className="mt-2 p-3 bg-amber-50 border-r-4 border-amber-600 rounded-r-lg text-amber-950 text-xs flex items-start gap-2 animate-bounce-short" id="live-name-warning-badge">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-navy/20 focus:border-brand-navy transition text-right font-mono"
                />
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="مثال: القاهرة، الجيزة، المنوفية ..."
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-navy/20 focus:border-brand-navy transition text-right"
                />
              </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-navy/20 focus:border-brand-navy transition cursor-pointer"
                id="student-education-select"
              >
                <option value="ثانوية عامة">طالب ثانوية عامة (أو معادلها)</option>
                <option value="ثانوية أزهرية">طالب ثانوية أزهرية</option>
                <option value="دبلوم فني صناعي">طالب دبلوم فني صناعي</option>
                <option value="دبلوم فني تجاري">طالب دبلوم فني تجاري</option>
                <option value="دبلوم فني زراعي">طالب دبلوم فني زراعي</option>
                <option value="دبلوم صحي أو فني أخر">دبلوم فني أو صحي أخر</option>
                <option value="خريج أو راغب في تغيير المسار المهني">خريج راغب في تغيير المسار المهني</option>
              </select>
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-navy/20 focus:border-brand-navy transition cursor-pointer font-semibold"
              >
                <option value="دورة أكتوبر 2026 (الرئيسية)">دورة أكتوبر 2026 (الدفعة الرئيسية - احجز مقعدك الآن)</option>
                <option value="دورة يناير 2027">دورة يناير 2027 (الدفعة الشتوية)</option>
                <option value="دورة مارس 2027">دورة مارس 2027 (الفصل الدراسي الثاني)</option>
                <option value="دورة مايو 2027">دورة مايو 2027 (التقديم الصيفي المبكر)</option>
              </select>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-navy/20 focus:border-brand-navy transition text-right resize-none h-24"
              />
            </div>
          </div>
