    ...
    >
      ...
      <div className="max-w-5xl w-full flex flex-col items-center relative z-10 text-center space-y-6">
        ...
        <div className="flex flex-col items-center gap-3 px-2">
          <h1 className="text-lg sm:text-2xl md:text-5xl font-black text-white text-center leading-tight">
            بوابتك الموثوقة لمستقبل عملي حقيقي <br />
            <span className="bg-gradient-to-r from-amber-400 via-orange-400 to-yellow-300 bg-clip-text text-transparent inline-block mt-1.5 md:mt-2">
              وتصفح أقسام الأكاديميات المعتمدة
            </span>
          </h1>
          <SpeechButton 
            textToSpeak="بوابتك الموثوقة لمستقبل عملي حقيقي وتصفح أقسام الأكاديميات المعتمدة. تصفح الدليل الأحدث لعام ألفين وستة وعشرين لأكثر من سبعة عشر شعبة علمية وهندسية وصحية معتمدة محلياً."
            className="mt-1 bg-white/10 text-amber-300 border-white/20 hover:bg-amber-500 hover:text-white"
          />
        </div>
