...
import { Cpu, HeartPulse, Droplet, Plane, FlaskConical, Map, TrendingUp, UserCheck } from "lucide-react";
            ...
            >
              ...
              <div className="flex items-center justify-between border-t border-slate-200/50 mt-3 pt-3">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-slate-900 text-white hover:bg-brand-navy rounded-xl text-[10px] font-bold transition flex items-center gap-1 cursor-pointer hover:shadow-xs"
                >
